...
const output2 = document.getElementById("img-data2");
const output3 = document.getElementById("img-data3");
const imgPreview = document.getElementById("img-preview");
function doneButton(){
    document.getElementById("cropWindow").hidden=true;
    document.getElementById("potatoType").disabled=false;
...
document.getElementById("potatoType").disabled=true;
