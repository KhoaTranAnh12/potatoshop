        ...
        <div class="fixed-top">
            <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
                <div class="container-fluid">
                    <div class="navbar-brand"><h1><a style="text-decoration: none; color: white" href="../controller/?perm=client">potato.shop</a></h1></div>
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link" href="../controller/?perm=client&action=signup">Đăng ký</a></li>
                        <li class="nav-item"><a class="nav-link" href="../controller/?perm=client&action=login">Đăng nhập</a></li>
                        <li class="nav-item" hidden><a class="nav-link" href="../controller/?perm=client&action=info">
                            <img src="<?php echo $customer['avatar'];?>" alt="avatar" style="width: 2rem;">
                        </a></li>
                        
                        <li class="nav-item" hidden><a class="nav-link" href="../controller/?perm=client&action=login">Đăng xuất</a></li>
                        <?php
            ...
            <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
                <div class="container-fluid">
                    <div class="header__references">
                        <ul class="navbar-nav">
                            <li class="nav-item"><a class="nav-link" href="../controller/?perm=client&action=about">Về Potato.shop</a></li>
                        </ul>
                    </div>
                    <form method="get" id="searchForm" action="../controller/" class="header__search d-flex ml-auto">
                        <input name="perm" type="hidden" value="client">
                        ...
                        foreach($allnews as $n)
                        {
                            ...
                            if($first)
                            {
                                ...
                                <div class="carousel-item active">
                                    <a href="../controller/?perm=client&action=news&id='.$id.'"><img class="d-block w-100" src="'.$image.'" alt="First slide"></a>
                                </div>
                                ';
                                $first = false;
                            }
                        ...
                        for($i=1;$i<=2;$i++)
                        {
                            extract($allnews[$i-1]);
                            {
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <a href="../controller/?perm=client&action=news&id='.$id.'"><img class="w-100" src="'.$secondaryimage.'" alt="abc"></a>
                                </div>
                                ';
                                $first = false;
                            }
                    ...
                    <?php
                        ...
                        foreach($last10articles as $row){
                            ...
                            <tr>
                                ...
                                <td>'.$title.'</td>
                                <td>'.$content.'</td>
                                <td><a href="../controller/?perm=client&action=article&id='.$id.'"><img src="'.$image.'" style="max-height: 200px;"></a></td>
                            </tr>
                            ';
                            $count++;
                        }
